...
public class Assert_my extends Assert {
    ...
    static String format(Object actual, Object expected, String message) {
        ...
        return formatted + ASSERT_LEFT2 + expected + ASSERT_MIDDLE + actual + ASSERT_RIGHT;
    }
...
//        调用截图方法
    ...
    public static void assertStartWith(String content, String prefix) {
        Assert_my.assertStartWith(content, prefix, null);
    }
    ...
    public static void assertEndWith(String content, String endfix) {
        Assert_my.assertEndWith(content, endfix, null);
    }
    ...
    public static void assertMatch(String matcher, String regex) {
        Assert_my.assertMatch(matcher, regex, null);
    }
    ...
    public static void assertNoMatch(String matcher, String regex) {
        Assert_my.assertNoMatch(matcher, regex, null);
    }
    ...
    public static void assertInclude(String content, String included) {
        Assert_my.assertInclude(content, included, null);
    }
}
